...
use Modules\RestaurantWebAddon\App\Exports\SupplierDueReportExport;
...
class AcnooSupplierDueReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('restaurantwebaddon::reports.supplier-due.due-reports', compact('due_lists'));
    }
    ...
    public function acnooFilter(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('restaurantwebaddon::reports.supplier-due.datas', compact('due_lists'))->render()
            ]);
        }
    ...
    public function generatePDF(Request $request)
    {
        ...
        $pdf = Pdf::loadView('restaurantwebaddon::reports.supplier-due.pdf', compact('due_lists'));
        return $pdf->download('supplier-due.pdf');
    }

    public function exportExcel()
    {
        return Excel::download(new SupplierDueReportExport, 'supplier-due.xlsx');
    }

    public function exportCsv()
    {
        return Excel::download(new SupplierDueReportExport, 'supplier-due.csv');
    }
}
