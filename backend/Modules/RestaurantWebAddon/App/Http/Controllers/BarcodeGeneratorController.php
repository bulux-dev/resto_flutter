...
class BarcodeGeneratorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('restaurantwebaddon::barcode-generators.index', compact('products', 'barcode_types'));
    }
    ...
    public function preview()
    {
        ...
        return view('restaurantwebaddon::barcode-generators.print', compact('generatedBarcodes', 'printer'));
    }
}
