<div class="modal fade common-validation-modal" id="modifiers-create-modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">{{ __('Create Modifier') }}</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="personal-info">
                    <form action="{{ route('business.modifiers.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <div class="gpt-up-down-arrow position-relative">
                                    <select class="form-control form-selected" name="product_id" required>
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <div class="gpt-up-down-arrow position-relative">
                                    <select class="form-control form-selected" name="modifier_group_id" required>
