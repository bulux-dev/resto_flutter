@foreach ($menus as $menu)
    <tr>
        ...
        <td class="w-60 checkbox">
            <input type="checkbox" name="ids[]" class="delete-checkbox-item  multi-delete" value="{{ $menu->id }}">
        </td>
        @endusercan
        ...
        <td class="d-print-none">
            <div class="d-flex align-items-center justify-content-end">
                <div class="icon-buttons">
                    ...
                    <a title="{{__('Edit')}}" data-bs-placement="top" href="#menu-edit-modal" data-bs-toggle="modal" class="menu-edit-btn action-btn edit"
                        data-url="{{ route('business.menus.update', $menu->id) }}" data-name="{{ $menu->name }}">
                    ...
                    @endusercan
                    @usercan('menus.delete')
                    <a title="{{__('Delete')}}" data-bs-placement="top" href="{{ route('business.menus.destroy', $menu->id) }}" class="confirm-action action-btn delete"
                        data-method="DELETE">
                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
