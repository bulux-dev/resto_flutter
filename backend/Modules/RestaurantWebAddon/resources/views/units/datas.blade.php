        ...
        <td class="d-print-none">
            <div class="d-flex align-items-center justify-content-end">
                <div class="icon-buttons">
                    ...
                    <a title="{{__('Edit')}}" data-bs-placement="top" href="#unit-edit-modal" data-bs-toggle="modal" class="units-edit-btn action-btn edit"
                    ...
                    @endusercan
                    @usercan('units.delete')
                    <a title="{{__('Delete')}}" data-bs-placement="top" href="{{ route('business.units.destroy', $unit->id) }}" class="confirm-action action-btn delete"
                        data-method="DELETE">
                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
