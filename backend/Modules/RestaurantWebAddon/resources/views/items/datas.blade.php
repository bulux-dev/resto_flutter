@foreach ($items as $item)
    <tr>
        ...
        <td class="w-60 checkbox">
            <input type="checkbox" name="ids[]" class="delete-checkbox-item  multi-delete" value="{{ $item->id }}">
        </td>
        @endusercan
        ...
        <td class="d-print-none">
            <div class="d-flex align-items-center justify-content-end">
                <div class="icon-buttons">
                    ...
                    <a title="{{__('Edit')}}" data-bs-placement="top" href="#item-edit-modal" class="item-edit-btn action-btn edit" data-bs-toggle="modal"
                        data-url="{{ route('business.items.update', $item->id) }}"
                        data-name="{{ $item->name }}">
                    ...
                    <!-- Delete Button -->
                    @usercan ('ingredients.delete')
                    <a title="{{__('Delete')}}" data-bs-placement="top" href="{{ route('business.items.destroy', $item->id) }}"
