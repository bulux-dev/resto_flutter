        ...
        <td class="d-print-none ">
            <div class="d-flex align-items-center justify-content-end">
                <div class="icon-buttons">
                    ...
                    <a title="{{__('Edit')}}" data-bs-placement="top" href="#category-edit-modal" class="category-edit-btn action-btn edit" data-bs-toggle="modal"
                    ...
                    @endusercan
                    @usercan('categories.delete')
                    <a title="{{__('Delete')}}" data-bs-placement="top" href="{{ route('business.categories.destroy', $category->id) }}"
