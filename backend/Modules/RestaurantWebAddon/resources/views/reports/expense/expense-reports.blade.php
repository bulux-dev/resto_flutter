    ...
    <div class="erp-table-section">
        <div class="container-fluid">
            ...
            <div class="section-title mb-3 d-flex align-items-center justify-content-between flex-wrap">
                ...
                <form action="{{ route('business.expense-reports.filter') }}" class="report-filter-form" method='post'
                    table="#expense-reports-data">
                    @csrf
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <div class="dropdown custom-dropdown">
                            ...
                            <div class="dropdown-content custom-dropdown-content">
                                <a href="{{ route('business.expense-reports.pdf') }}" class="custom-item"> {{ __('PDF') }} </a>
                                <a href="{{ route('business.expense-reports.csv') }}" class="custom-item"> {{ __('CSV') }} </a>
                                <a href="{{ route('business.expense-reports.excel') }}" class="custom-item"> {{ __('EXCEL') }} </a>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="responsive-table m-0">
                    <table class="table" id="datatable">
                        ...
                        <tbody id="expense-reports-data">
                            @include('restaurantwebaddon::reports.expense.datas')
                        </tbody>
                    </table>
                </div>
                <div class="mt-3">
