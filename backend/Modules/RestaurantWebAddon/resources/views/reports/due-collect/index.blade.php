        ...
        <div class="container-fluid">
            ...
            <div class="section-title mb-3 d-flex align-items-center justify-content-between flex-wrap">
                <h2> <a href="{{ route('business.dashboard.index') }}"> {{ __('Dashboard') }} </a>
                    ...
                    <span>/ {{ __('Due Collection') }} </span>
                </h2>
                <form action="{{ route('business.due-collect-reports.filter') }}" class="report-filter-form" method='post'
                    table="#due-collect-reports-data">
                    @csrf
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <div class="dropdown custom-dropdown">
                            ...
                            <div class="dropdown-content custom-dropdown-content">
                                <a href="{{ route('business.due-collect-reports.pdf') }}" class="custom-item">
                                    {{ __('PDF') }} </a>
                                <a href="{{ route('business.due-collect-reports.csv') }}" class="custom-item">
                                    {{ __('CSV') }} </a>
                                <a href="{{ route('business.due-collect-reports.excel') }}" class="custom-item">
                                    {{ __('EXCEL') }} </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="responsive-table m-0">
                    <table class="table" id="datatable">
                        ...
                        <tbody id="due-collect-reports-data">
                            @include('restaurantwebaddon::reports.due-collect.datas')
                        </tbody>
                    </table>
                </div>
                <div class="mt-3">
                    {{ $due_collections->links('vendor.pagination.bootstrap-5') }}
                </div>
            </div>
        </div>
    </div>
