@foreach ($expense_categories as $expense_category)
        ...
        <td class="d-print-none">
            <div class="d-flex align-items-center justify-content-end">
                <div class="icon-buttons">
                    ...
                    <a title="{{__('Edit')}}" data-bs-placement="top" href="#expense-categories-edit-modal" data-bs-toggle="modal"
                        class="expense-categories-edit-btn action-btn edit"
                        data-url="{{ route('business.expense-categories.update', $expense_category->id) }}"
                        data-name="{{ $expense_category->categoryName }}">
                    ...
                    @endusercan
                    @usercan('expenseCategory.delete')
                    <a title="{{__('Delete')}}" data-bs-placement="top" href="{{ route('business.expense-categories.destroy', $expense_category->id) }}"
    ...
    @include('restaurantwebaddon::expense-categories.edit')
@endforeach
