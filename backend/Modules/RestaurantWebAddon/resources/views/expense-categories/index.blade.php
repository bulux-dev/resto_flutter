...
@section('main_content')
        ...
        <div class="container-fluid">
                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <div class="dropdown custom-dropdown">
                            ...
                            <div class="dropdown-content custom-dropdown-content">
                                <a href="{{ route('business.expense-categories.pdf') }}" class="custom-item">
                                    {{ __('PDF') }} </a>
                                <a href="{{ route('business.expense-categories.csv') }}" class="custom-item">
                                    {{ __('CSV') }} </a>
                                <a href="{{ route('business.expense-categories.excel') }}" class="custom-item">
                                    {{ __('EXCEL') }} </a>
                            </div>
                        </div>
                        @usercan('expenseCategory.create')
                            <a type="button" href="#expense-categories-create-modal" data-bs-toggle="modal"
                                class="add-order-btn rounded-2" class="btn btn-primary"><i
                                    class="fas fa-plus-circle me-1"></i>{{ __('Add New') }}
                            </a>
                        @endusercan
                    </div>
                </form>
            ...
            <div class="card">
                <div class="card-bodys">
                    @usercan('expenseCategory.delete')
                        <div class="delete-item delete-show multi-delete-container d-none mb-3">
                            <div class="delete-item-show d-flex align-items-center justify-content-between w-100">
                                ...
                                <button data-bs-toggle="modal" class="trigger-modal" data-bs-target="#multi-delete-modal"
                                    data-url="{{ route('business.expense-categories.delete-all') }}">{{ __('Delete') }}</button>
                            </div>
                        </div>
                    @endusercan
                </div>
                ...
                <div class="responsive-table m-0">
                    <table class="table" id="datatable">
                        ...
                        <tbody id="expense-categories-data">
                            @include('restaurantwebaddon::expense-categories.datas')
                        </tbody>
                    </table>
                </div>
                <div class="mt-3">
    ...
    @include('restaurantwebaddon::expense-categories.create')
@endsection
