...
<div class="erp-state-overview-section">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4">
                <div class="erp-dashboard-profile card">
                    ...
                    <div class="profile-details card-body">
                        <ul class="list-group">
                            <li class="list-group-item"><span>{{ __('Shop Opening Balance') }}: </span>{{ currency_format($user->business?->shopOpeningBalance, currency: business_currency()) }}</li>
                            <li class="list-group-item"><span>{{ __('Shop Remaining Balance') }}: </span>{{ currency_format($user->business?->remainingShopBalance, currency: business_currency())}}</li>
            ...
            <div class="col-lg-8">
                <div class="erp-dashboard-profile-section order-form-section card">
                    <div class="table-header">
                        <h4 class="pb-2">{{__('User Profile')}}</h4>
                    </div>
