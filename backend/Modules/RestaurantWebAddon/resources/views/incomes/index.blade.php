                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <div class="dropdown custom-dropdown">
                            ...
                            <div class="dropdown-content custom-dropdown-content">
                                <a href="{{ route('business.incomes.pdf') }}" class="custom-item">
                                    {{ __('PDF') }} </a>
                                <a href="{{ route('business.incomes.csv') }}" class="custom-item">
                                    {{ __('CSV') }} </a>
                                <a href="{{ route('business.incomes.excel') }}" class="custom-item">
                                    {{ __('EXCEL') }} </a>
                            </div>
                        </div>
                        @usercan('income.create')
                        <a type="button" href="#incomes-create-modal" data-bs-toggle="modal"
                            class="add-order-btn rounded-2"
                            class="btn btn-primary"><i class="fas fa-plus-circle me-1"></i>{{ __('Add Income') }}</a>
                        @endusercan
                    </div>
                </form>
            </div>
                ...
                <div class="responsive-table m-0">
                    <table class="table" id="datatable">
                        ...
                        <tbody id="incomes-data">
                            @include('restaurantwebaddon::incomes.datas')
                        </tbody>
                    </table>
                </div>
                <div class="mt-3">
...
@push('modal')
    ...
    @include('restaurantwebaddon::incomes.create')
    @include('restaurantwebaddon::incomes.edit')
@endpush
