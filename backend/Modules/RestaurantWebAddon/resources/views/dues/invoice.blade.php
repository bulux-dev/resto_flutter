...
@section('main_content')
    <div class="invoice-container-sm">
        <div class="invoice-content invoice-content-size">
            ...
            <div class="mt-2">
                <h4 class="company-name"> {{ $due_collect->business?->companyName ?? 'Restaurant App' }} </h4>
                <div class="company-info">
                    <p> {{__('Address')}} : {{ $due_collect->business?->address ?? '' }}</p>
                    <p> {{__('Mobile')}} : {{ $due_collect->business?->phoneNumber ?? '' }}</p>
            ...
            <div class="invoice-info">
                <div class="">
                    ...
                    <p>{{__('Name')}} : {{ $due_collect->party->name ?? '' }} </p>
