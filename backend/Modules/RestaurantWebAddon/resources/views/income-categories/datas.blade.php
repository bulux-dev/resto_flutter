        ...
        <td class="d-print-none">
            <div class="d-flex align-items-center justify-content-end">
                <div class="icon-buttons">
                    @usercan('incomeCategory.update')
                    <a title="{{__('Edit')}}" data-bs-placement="top" href="#income-categories-edit-modal" data-bs-toggle="modal" class="income-categories-edit-btn action-btn edit"
                        data-url="{{ route('business.income-categories.update', $income_category->id) }}"
                        data-name="{{ $income_category->categoryName }}">
                    ...
                    @endusercan
                    @usercan('incomeCategory.delete')
                    <a title="{{__('Delete')}}" data-bs-placement="top" href="{{ route('business.income-categories.destroy', $income_category->id) }}" class="confirm-action action-btn delete" data-method="DELETE">
                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
...
@push('modal')
   @include('restaurantwebaddon::income-categories.edit')
@endpush
