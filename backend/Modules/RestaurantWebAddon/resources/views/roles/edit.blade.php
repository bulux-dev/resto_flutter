                                ...
                                <div class="row">
                                    <div class="col-lg-4 form-group role-input-label">
                                        <div class="w-100">
                                            ...
                                            <div class="gpt-up-down-arrow position-relative w-100">
                                                <select class="form-control form-selected" name="staff_id" required>
                                                    <option value="">{{ __('Select') }}</option>
                                                    @foreach ($staffs as $staff)
                                                    <option @selected($user->staff_id == $staff->id) value="{{ $staff->id }}">{{ $staff->name }}</option>
                                                    @endforeach
                                                </select>
                                                <span></span>
                                            </div>
                                    ...
                                    <div class="col-lg-4 form-group role-input-label">
                                        <div class="w-100">
                                            ...
                                            <input type="text" name="email" value="{{ $user->email }}" id="email" class="form-control w-100" placeholder="{{ __('Enter Email Address') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 form-group role-input-label">
                                        <div class="w-100">
                                            <label for="password" class="required">{{ __('Password') }}</label>
                                            <input type="password" name="password" id="password" class="form-control w-100" placeholder="{{ __('Enter Password') }}">
                                        </div>
                                    </div>
                                    <div class="col-12 ">
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="custom-control custom-checkbox mr-3 me-4 d-flex align-items-center  ">
                                                                    <label class="table-custom-checkbox">
                                                                        ...
                                                                        table-hidden-checkbox checkbox-item" id="{{ $module }}_{{ $action }}" @checked(isset($user) && !empty($user->visibility[$module][$action]))>
