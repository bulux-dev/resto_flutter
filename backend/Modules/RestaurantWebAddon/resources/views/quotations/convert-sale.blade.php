                        ...
                        <div class="order-form-section select-container">
                            ...
                            <div class="row g-3" data-type="dine_in">
                                <div class="col-md-6 ">
                                    <div class="gpt-up-down-arrow position-relative">
                                        <select name="staff_id" class="form-control table-select w-100 ">
                                        ...
                                        <div class="gpt-up-down-arrow position-relative custom-select-wrapper">
                                            <select name="party_id" class="form-control table-select customer-select w-100 choices-select" data-modal="#customer-create-modal">
                                                ...
                                                @foreach ($customers as $cstomer)
                                                    <option @selected($quotation->party_id == $cstomer->id) value="{{ $cstomer->id }}">{{ $cstomer->name }}({{__('Due')}}: {{ currency_format($cstomer->due ?? 0, currency: business_currency()) }})</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <div class="custom-add-button">
                                                ...
                                                <a type="button" href="#customer-create-modal" data-bs-toggle="modal">
                                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                        ...
                                                        <path d="M10.0009 4.16675V15.8351" stroke="#FC8019" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M15.835 10.0017H4.16663" stroke="#FC8019" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                </a>
                                                @endusercan
                            ...
                            <div class="row g-3 mt-3" data-type="delivery">
                                ...
                                <div class="col-md-12">
                                    <div class="">
                                        <div class="gpt-up-down-arrow position-relative custom-select-wrapper">
                                            <select name="address_id" id="deliveryAddressAppend"
                                                class="form-control table-select customer-select w-100">
                        ...
                        <div class="bottom-amount-section">
                            <div class="payment-container">
                                ...
                                <div class="custom-form-group">
                                    ...
                                    <input type="number" name="paidAmount" id="receive_amount" class="custom-input" placeholder="{{__('Ex: 10')}}"  value="{{ $quotation->paidAmount }}">
                                </div>
                            ...
                            <div class="payment-container">
                                ...
                                <div class="pay-row">
                                    <span class="pay-label-text vatOnSale" data-vat-sale="{{ $vat_on_sale->rate ?? 0 }}">
                                        {{ $vat_on_sale->name ?? 'N/A' }} ({{ $vat_on_sale->rate ?? 0 }} %)
                                    </span>
                                ...
                                <div class="pay-row coupon-row">
                                    <div class="d-flex align-items-center">
                                        <a href="#couponModal" class="pay-label-text coupon getCoupon" data-bs-toggle="modal">{{__('Coupon')}} <span
                                ...
                                <input type="hidden" class="coupondiscount" value="{{ $quotation->coupon->discount ?? '' }}" id="coupondiscount">
                                <input type="hidden" class="couponType" value="{{ $quotation->coupon->discount_type ?? '' }}" id="couponType">


                                <div class="pay-row discount-row">
                                    <span class="pay-label-text">{{__('Discount')}} (<span class="discountPercentageShow"></span>%)</span>
                                    <input type="number" name="discountAmount" class="discount-input discount_amount"  value="{{ $quotation->discountAmount }}" placeholder="{{__('Ex: 10')}}">
                                </div>
                                <input type="hidden" name="discountPercentage" class="discountPercentageShow">

                                <div class="pay-row discount-row">
                                    <span class="pay-label-text">{{__('Tips')}}</span>
                                    <input type="number" name="tip" class="discount-input tip" value="{{ $quotation->meta['tip'] ?? '' }}" placeholder="{{__('Ex: 10')}}">
                                </div>

                                @usercan ('quotations.update')
                                <button type="submit" class="payment-footer w-100 submit-btn" id="paymentBtnHide"
                                    name="is_payment" value="0">
