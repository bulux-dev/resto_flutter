        ...
        <td class="d-print-none">
            <div class="d-flex align-items-center justify-content-end">
                <div class="icon-buttons">
                    @usercan('vat.update')
                    <a title="{{__('Edit')}}" data-bs-placement="top" href="#vat-edit-modal" data-bs-toggle="modal" class="vat-edit-btn action-btn edit"
                        data-url="{{ route('business.vats.update', $vat->id) }}"
                        data-vat-name="{{ $vat->name }}" data-rate="{{ $vat->rate }}"
                        data-vat-sale="{{ $vat->vat_on_sale == '1' ? 'checked' : '' }}"
