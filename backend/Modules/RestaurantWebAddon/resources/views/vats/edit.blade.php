                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="add-brand-form pt-0 ajaxform_instant_reload updateVatForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-3">
                                ...
                                <input type="number" name="rate" id="vat_rate" required class="form-control" placeholder="{{ __('Enter rate - %') }}">
                            </div>
                            ...
                            <div class="col-lg-6 mt-3 d-flex align-items-center">
                                <label for="vat_sale" class="me-4">{{__('Vat On Sale')}}</label>
                                <label class="switch mb-0 me-3">
                                    <input type="hidden" name="vat_on_sale" value="0">
                                    <input type="checkbox" id="vat_sale" name="vat_on_sale" value="1">
                        ...
                        <div class="offcanvas-footer mt-3 d-flex justify-content-center">
                            <button type="button" data-bs-dismiss="modal" class="theme-btn border-btn m-2" data-bs-dismiss="offcanvas" aria-label="Close">{{ __('Cancel') }}</button>
