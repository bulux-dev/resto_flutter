                            ...
                            <div class="add-suplier-modal-wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 mt-2">
                                        ...
                                        <input type="file" name="image" required class="form-control" onchange="newPreviewImage(this, 'ImagePreview')">
                                    </div>
                                    <div class="col-lg-1 mt-2 align-self-center mt-4">
                                        <img class="img-fluid table-img mt-lg-3" id="ImagePreview"
