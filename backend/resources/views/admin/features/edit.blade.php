                            ...
                            <div class="add-suplier-modal-wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 mt-2 align-self-center">
                                        ...
                                        <input type="file" name="image" class="form-control" onchange="newPreviewImage(this, 'ImagePreview')">
                                    </div>
                                    <div class="col-lg-1 mt-2 align-self-center mt-4">
                                        <img id="ImagePreview" class="table-img mt-lg-3" src="{{ asset($feature->image ?? 'assets/images/icons/upload.png') }}" alt="img">
                                    </div>
