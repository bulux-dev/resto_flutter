                                                ...
                                                <div class="tab-content no-padding">
                                                    ...
                                                    <div class="tab-pane fade" id="mail-configuration">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="QUEUE_MAIL" id="QUEUE_MAIL" class="form-control choices-select">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="gpt-up-down-arrow position-relative">
                                                                <select name="MAIL_DRIVER_TYPE" class="form-control choices-select" id="mail-driver-type-select">
                                                    ...
                                                    <div class="tab-pane fade" id="storage">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="gpt-up-down-arrow position-relative">
                                                            <select class="form-control choices-select" name="FILESYSTEM_DISK">
                                                    ...
                                                    <div class="tab-pane fade" id="other">
                                                        <div class="">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="gpt-up-down-arrow position-relative">
                                                                    <select class="form-control choices-select" name="TIMEZONE" id="TIMEZONE" >
