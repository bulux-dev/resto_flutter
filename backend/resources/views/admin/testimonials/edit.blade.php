                        ...
                        <div class="add-suplier-modal-wrapper">
                            <div class="row">
                                ...
                                <div class="col-lg-5 mt-2 align-self-center">
                                    ...
                                    <input type="file" name="client_image" class="form-control" onchange="newPreviewImage(this, 'clientImagePreview')">
                                </div>
                                <div class="col-lg-1 mt-2 align-self-center mt-4">
                                    <img id="clientImagePreview" class="img-fluid table-img mt-lg-3" src="{{ asset($testimonial->client_image ?? 'assets/images/icons/upload.png') }}" alt="Img">
                                </div>

                                <div class="col-lg-12 mt-2">
                                    <label>{{ __('Review') }}</label>
                                    <textarea name="text" class="form-control" placeholder="{{ __('Enter review message here') }}">{{ $testimonial->text }}</textarea>
                                </div>
