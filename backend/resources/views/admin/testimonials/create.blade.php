                            ...
                            <div class="add-suplier-modal-wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mt-2">
                                        ...
                                        <input type="text" name="work_at" required class="form-control"
                                    ...
                                    <div class="col-lg-1 mt-2 align-self-center mt-4">
                                        <img class="img-fluid table-img mt-lg-3" id="clientImagePreview"
                                            src="{{ asset('assets/images/icons/upload.png') }}" alt="Img">
                                    </div>
