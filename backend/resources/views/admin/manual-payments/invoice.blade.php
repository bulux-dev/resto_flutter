        ...
        <div class="invoice-content">
            <div class="p-3 py-2 d-flex align-items-center justify-content-between d-print-none border-bottom print-container">
                <div class="d-flex align-items-center table-header border-0 d-print-none">
                    <h4 class="Money-Receipt">{{ __('Manual Payment Report') }}</h4>
                </div>
                <div class="d-flex justify-content-end align-items-end d-print-none">
                    <div class="d-flex gap-3">
                        <a class="print-btn-2 print-btn-invoice print-window" >
                            ...
                            <path d="M14.6673 6.6665V4.99984C14.6673 3.42849 14.6673 2.64281 14.1792 2.15466C13.691 1.6665 12.9053 1.6665 11.334 1.6665H9.66732C8.09597 1.6665 7.31029 1.6665 6.82214 2.15466C6.33398 2.64281 6.33398 3.42849 6.33398 4.99984V6.6665" stroke="white" stroke-width="1.5" stroke-linejoin="round"></path>
                            ...
                            <path d="M15.5 10H15.5075" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                            {{ __('Print') }}</a>
                    </div>
                </div>
            ...
            <div class="p-3">
                ...
                <div class="d-flex align-items-start justify-content-between custom-invoice-table">
                    <div>
                        <table class="table">
                            <tbody>
                ...
                <div class="d-flex align-items-center justify-content-between position-relative custom-invoice-table">
                    <div>
                        <table class="table">
                            <tbody>
                                <tr class="in-table-row">
