@foreach($plans as $plan)
    <tr class="table-content">
        ...
        <td>
            <img class="table-img" src="{{ asset($plan->icon ?? 'assets/img/icon/no-image.svg') }}" alt="icon">
        </td>
        <td>{{ $plan->duration }} </td>
        ...
        <td class="table-single-header">
            <div class="{{ $plan->is_popular == 1 ? 'badge bg-success' : 'badge bg-danger' }}">
                {{ $plan->is_popular == 1 ? 'Yes' : 'No' }}
            </div>
        </td>
        <td class="table-single-content d-print-none">
            <div class="dropdown table-action">
                ...
                <ul class="dropdown-menu">
                    ...
                    @endcan
                    <li>
                        <a href="{{ route('admin.plans.popular', ['id' => $plan->id]) }}">
