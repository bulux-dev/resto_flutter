    ...
    <section class="contact-section">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{ $page_data['headings']['contact_us_start_title'] ?? '' }} <span class="highlight-title">{{ $page_data['headings']['contact_us_mid_title'] ?? '' }}</span> {{ $page_data['headings']['contact_us_end_title'] ?? '' }}</h2>
                <p>
            ...
            <div class="row">
                <div class="col-lg-6 mb-3 align-self-center">
                    <div class="contact-image">
                        <img src="{{ asset($page_data['contact_us_img'] ?? '') }}"
